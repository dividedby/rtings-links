...
### Issue tracker
GitHub issues in `dividedby/rtings-links` (via `gh`). See `docs/agents/issue-tracker.md`.
...
**enriched row** to this repo's [**Idea Inbox**](https://github.com/dividedby/rtings-links/issues/1) issue (label
